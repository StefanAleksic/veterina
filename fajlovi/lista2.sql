...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2018 at 11:08 AM
...
--
-- Dumping data for table `lista2`
--

INSERT INTO `lista2` (`id`, `br_leg`, `ime`, `prezime`, `jmbg`, `pol`, `state`, `prebivaliste`, `rang`, `sud_lista`, `description`) VALUES
...
(7, 'I-152', 'Uroš', 'Đurđević', '0405980345234', 1, 'Mirovanje', 'Beograd', 3, 4, ''),
(8, 'I-056', 'Miloš', 'Ninković', '3101978713456', 1, 'Aktivan', 'Beograd', 3, 4, ''),
